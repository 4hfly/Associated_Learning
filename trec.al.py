...
parser = argparse.ArgumentParser('TREC QC Dataset for AL training')
...
# dir param
parser.add_argument('--save-dir', type=str, default='ckpt/trec.al.pt')
...
print('TREC model param num', get_n_params(model))
